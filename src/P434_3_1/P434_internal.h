...
#include "../config.h"
    ...
    #define p434_ZERO_WORDS 3               // Number of "0" digits in the least significant part of p443 + 1     
...
#define BOB_PRIMES              1  // Number of primes for Bob's part
#define ALICE                   0
#define BOB                     1  //BOB3
#define BOB1                    2
#define OALICE_BITS             216  
#define OBOB_BITS               218 //BOB3 
...
#define MAX_INT_POINTS_ALICE    108  
#define MAX_INT_POINTS_BOB      137 
...
typedef digit_t felm_t[NWORDS_FIELD];                                 // Datatype for representing 434-bit field elements (768-bit max.)
typedef digit_t dfelm_t[2*NWORDS_FIELD];                              // Datatype for representing double-precision 2x434-bit field elements (2x768-bit max.) 
...
void sqr434_asm(const digit_t* a, digit_t* b);
