...
{ // Efficient Montgomery reduction using comba and exploiting the special form of the prime p434.
  ...
  // ma is assumed to be in Montgomery representation.
    ...
    mc[3] = ma[3];
    mc[4] = ma[4];
    MUL128(mc[0], ((digit_t*)p434p1)[5], uv);
    ...
    MULADD128(mc[0], ((digit_t*)p434p1)[7], uv, carry, uv);
    t += carry;
    ...
    MULADD128(mc[0], ((digit_t*)p434p1)[8], uv, carry, uv);
    t += carry;
    MULADD128(mc[1], ((digit_t*)p434p1)[7], uv, carry, uv);
    t += carry;
    ...
    MULADD128(mc[0], ((digit_t*)p434p1)[9], uv, carry, uv);
    t += carry;
    MULADD128(mc[1], ((digit_t*)p434p1)[8], uv, carry, uv);
    t += carry;
    MULADD128(mc[2], ((digit_t*)p434p1)[7], uv, carry, uv);
    t += carry;
    ...
    MULADD128(mc[0], ((digit_t*)p434p1)[10], uv, carry, uv);
    t += carry;
    MULADD128(mc[1], ((digit_t*)p434p1)[9], uv, carry, uv);
    t += carry;
    MULADD128(mc[2], ((digit_t*)p434p1)[8], uv, carry, uv);
    t += carry;
    MULADD128(mc[3], ((digit_t*)p434p1)[7], uv, carry, uv);
    t += carry;
    ...
    MULADD128(mc[0], ((digit_t*)p434p1)[11], uv, carry, uv);
    t += carry;
    MULADD128(mc[1], ((digit_t*)p434p1)[10], uv, carry, uv);
    t += carry;
    MULADD128(mc[2], ((digit_t*)p434p1)[9], uv, carry, uv);
    t += carry;
    MULADD128(mc[3], ((digit_t*)p434p1)[8], uv, carry, uv);
    t += carry;
    MULADD128(mc[4], ((digit_t*)p434p1)[7], uv, carry, uv);
    t += carry;
    ...
    MULADD128(mc[1], ((digit_t*)p434p1)[11], uv, carry, uv);
    t += carry;
    MULADD128(mc[2], ((digit_t*)p434p1)[10], uv, carry, uv);
    t += carry;
    MULADD128(mc[3], ((digit_t*)p434p1)[9], uv, carry, uv);
    t += carry;
    MULADD128(mc[4], ((digit_t*)p434p1)[8], uv, carry, uv);
    t += carry;
    MULADD128(mc[5], ((digit_t*)p434p1)[7], uv, carry, uv);
    t += carry;
    MULADD128(mc[6], ((digit_t*)p434p1)[6], uv, carry, uv);
    t += carry;
    MULADD128(mc[7], ((digit_t*)p434p1)[5], uv, carry, uv);
    t += carry;
    ...
    MULADD128(mc[2], ((digit_t*)p434p1)[11], uv, carry, uv);
    t += carry;
    MULADD128(mc[3], ((digit_t*)p434p1)[10], uv, carry, uv);
    t += carry;
    MULADD128(mc[4], ((digit_t*)p434p1)[9], uv, carry, uv);
    t += carry;
    MULADD128(mc[5], ((digit_t*)p434p1)[8], uv, carry, uv);
    t += carry;
    MULADD128(mc[6], ((digit_t*)p434p1)[7], uv, carry, uv);
    t += carry;
    MULADD128(mc[7], ((digit_t*)p434p1)[6], uv, carry, uv);
    t += carry;
    MULADD128(mc[8], ((digit_t*)p434p1)[5], uv, carry, uv);
    t += carry;
    ...
    MULADD128(mc[3], ((digit_t*)p434p1)[11], uv, carry, uv);
    t += carry;
    MULADD128(mc[4], ((digit_t*)p434p1)[10], uv, carry, uv);
    t += carry;
    MULADD128(mc[5], ((digit_t*)p434p1)[9], uv, carry, uv);
    t += carry;
    MULADD128(mc[6], ((digit_t*)p434p1)[8], uv, carry, uv);
    t += carry;
    MULADD128(mc[7], ((digit_t*)p434p1)[7], uv, carry, uv);
    t += carry;
    MULADD128(mc[8], ((digit_t*)p434p1)[6], uv, carry, uv);
    t += carry;
    MULADD128(mc[9], ((digit_t*)p434p1)[5], uv, carry, uv);
    t += carry;
    ...
    MULADD128(mc[4], ((digit_t*)p434p1)[11], uv, carry, uv);
    t += carry;
    MULADD128(mc[5], ((digit_t*)p434p1)[10], uv, carry, uv);
    t += carry;
    MULADD128(mc[6], ((digit_t*)p434p1)[9], uv, carry, uv);
    t += carry;
    MULADD128(mc[7], ((digit_t*)p434p1)[8], uv, carry, uv);
    t += carry;
    MULADD128(mc[8], ((digit_t*)p434p1)[7], uv, carry, uv);
    t += carry;
    MULADD128(mc[9], ((digit_t*)p434p1)[6], uv, carry, uv);
    t += carry;
    MULADD128(mc[10], ((digit_t*)p434p1)[5], uv, carry, uv);
    t += carry;
    ...
    MULADD128(mc[5], ((digit_t*)p434p1)[11], uv, carry, uv);
    t += carry;
    MULADD128(mc[6], ((digit_t*)p434p1)[10], uv, carry, uv);
    t += carry;
    MULADD128(mc[7], ((digit_t*)p434p1)[9], uv, carry, uv);
    t += carry;
    MULADD128(mc[8], ((digit_t*)p434p1)[8], uv, carry, uv);
    t += carry;
    MULADD128(mc[9], ((digit_t*)p434p1)[7], uv, carry, uv);
    t += carry;
    MULADD128(mc[10], ((digit_t*)p434p1)[6], uv, carry, uv);
    t += carry;
    MULADD128(mc[11], ((digit_t*)p434p1)[5], uv, carry, uv);
    t += carry;
    ...
    MULADD128(mc[6], ((digit_t*)p434p1)[11], uv, carry, uv);
    t += carry;
    MULADD128(mc[7], ((digit_t*)p434p1)[10], uv, carry, uv);
    t += carry;
    MULADD128(mc[8], ((digit_t*)p434p1)[9], uv, carry, uv);
    t += carry;
    MULADD128(mc[9], ((digit_t*)p434p1)[8], uv, carry, uv);
    t += carry;
    MULADD128(mc[10], ((digit_t*)p434p1)[7], uv, carry, uv);
    t += carry;
    MULADD128(mc[11], ((digit_t*)p434p1)[6], uv, carry, uv);
    t += carry;
    ...
    MULADD128(mc[7], ((digit_t*)p434p1)[11], uv, carry, uv);
    t += carry;
    MULADD128(mc[8], ((digit_t*)p434p1)[10], uv, carry, uv);
    t += carry;
    MULADD128(mc[9], ((digit_t*)p434p1)[9], uv, carry, uv);
    t += carry;
    MULADD128(mc[10], ((digit_t*)p434p1)[8], uv, carry, uv);
    t += carry;
    MULADD128(mc[11], ((digit_t*)p434p1)[7], uv, carry, uv);
    t += carry;
    ...
    MULADD128(mc[8], ((digit_t*)p434p1)[11], uv, carry, uv);
    t += carry;
    MULADD128(mc[9], ((digit_t*)p434p1)[10], uv, carry, uv);
    t += carry;
    MULADD128(mc[10], ((digit_t*)p434p1)[9], uv, carry, uv);
    t += carry;
    MULADD128(mc[11], ((digit_t*)p434p1)[8], uv, carry, uv);
    t += carry;
    ...
    MULADD128(mc[9], ((digit_t*)p434p1)[11], uv, carry, uv);
    t += carry;
    MULADD128(mc[10], ((digit_t*)p434p1)[10], uv, carry, uv);
    t += carry;
    MULADD128(mc[11], ((digit_t*)p434p1)[9], uv, carry, uv);
    t += carry;
    ...
    MULADD128(mc[10], ((digit_t*)p434p1)[11], uv, carry, uv);
    t += carry;
    MULADD128(mc[11], ((digit_t*)p434p1)[10], uv, carry, uv);
    t += carry;
    ...
    MULADD128(mc[11], ((digit_t*)p434p1)[11], uv, carry, uv);
    t += carry;
