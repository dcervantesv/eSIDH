/********************************************************************************************
* Abstract: run tests against known answer test vectors for SIKEp765
*
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_SIKEp765(pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_enc_SIKEp765(ct, ss, pk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_SIKEp765(ss1, ct, sk)) != 0) {
