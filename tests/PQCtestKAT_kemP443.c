/********************************************************************************************
* Abstract: run tests against known answer test vectors for SIKEp443
*
...
main()
{
    ...
    do {
        ...
        if ( (ret_val = crypto_kem_keypair_SIKEp443(pk, sk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_enc_SIKEp443(ct, ss, pk)) != 0) {
        ...
        if ( (ret_val = crypto_kem_dec_SIKEp443(ss1, ct, sk)) != 0) {
